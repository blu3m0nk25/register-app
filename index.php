...
<!DOCTYPE html><!-- set this class so CSS definitions that now use REM size, would work relative to this.
	Since now almost everything is relative to one of the 2 absolute font size classese --><html class="user_font_size_normal" lang="en"><head>
<!--
 login.jsp
 * ***** BEGIN LICENSE BLOCK *****
...
-->
	...
	<link rel="stylesheet" type="text/css" href="https://mail.bcc.gov.bd//css/common,login,zhtml,skin.css?skin=harmony&amp;v=250124034840">
	<link rel="SHORTCUT ICON" href="https://mail.bcc.gov.bd//img/logo/favicon.ico">
	...
	<div id="modifiedLogin" class="LoginScreen">
		<div class="modernCenter">
				...
				<form id="zLoginForm" method="post" name="loginForm"  accept-charset="UTF-8">
								...
								<input type="hidden" name="login_csrf" value="59cd8502-601c-4d60-8ae6-2d61722e7961">

								<div class="signIn">Sign In</div>
                        <div class="form">
                        <div id="errorMessageDiv" class="errorMessage" style="display:block !important;">Invalid session. Please log in again.</div>
...
,banner:{
position:"static",url:"http://bcc.gov.bd"}
,favicon:{
dir:""}
,userInfo:{
position:"static"}
...
,hideSearchInCompose:true,notificationBanner:"/skins/_base/logos/NotificationBanner_grey.gif?v=250124034840"};
...
<script>document.getElementById('username')?.focus();</script></body></html>
